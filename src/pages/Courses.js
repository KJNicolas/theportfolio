  ...
  return (
    <Layout>
      ...
      <div className="mt-20 md:mt-5">
        ...
        <h1 className="text-4xl text-center text-white font-bold mt-5">Because</h1>
      </div>
      <div className="font-bold text-center bg-yellow-500 m-20 p-20 text-white rounded-tl-full rounded-br-full md:mx-5">
        <h1 className="text-8xl md:text-3xl" data-aos='slide-down'>LEARNING IS...</h1>
        <h1 className="text-8xl md:text-3xl" data-aos='slide-up'>CONTAGIOUS</h1>
      </div>
